...
import com.gmail.semih.ui.views.storefront.events.NewEditorEvent;
import com.gmail.semih.ui.views.storefront.events.TotalPriceChangeEvent;
...
public class OrderItemsEditor extends Div implements HasValueAndElement<ComponentValueChangeEvent<OrderItemsEditor,List<OrderItem>>, List<OrderItem>> {
	...
	private void setHasChanges(boolean hasChanges) {
		...
		if (hasChanges) {
			fireEvent(new com.gmail.semih.ui.views.storefront.events.ValueChangeEvent(this));
		}
	}
